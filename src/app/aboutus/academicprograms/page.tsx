...
const courseData = {
  placement: [
    ...
    { sno: 10, program: "Electrical Engineering with specialization in Communication and Signal Processing ", degree: "MTech" },
    ...
    { sno: 34, program: "MS (Research) in Computer Science and Engineering", degree: "MS(Research)" },
    { sno: 35, program: "MS (Research) in Electrical Engineering", degree: "MS(Research)" },
    { sno: 36, program: "MS (Research) in Mechanical Engineering", degree: "MS(Research)" },
    { sno: 37, program: "M.S. (Research) in Space Science and Engineering from Department of Astronomy, Astrophysics And Space Engineering(DAASE)", degree: "MS(Research)" },
    { sno: 38, program: "M.S. (Research) in Humanities and Social Science from School of Humanities and Social Science (HSS)", degree: "MS(Research)" },
